...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- search form -->
      <form action="pencarian_4c.php" method="POST" class="sidebar-form">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Pengembangan Sistem
        <small>4c. Penelaan Pengembangan Sistem Kepustakawanan</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Penelaan Sistem</a></li>
        <li class="active">4c. Penelaan Pengembangan Sistem Kepustakawanan</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                               ...
                               <h3 align="center">4C. PENELAAH PENGEMBANGAN SISTEM KEPUSTAKAWANAN</h3>      
                               </i> <br><br>
                                            ...
                                            <form action="" method="POST" enctype="multipart/form-data">
                                                       ...
                                                       <select id="riwayat" name="riwayat" class="datepicker form-control" required>
                                                        <option>Pilih</option>
                                                           <?php
                                                             ...
                                                             $sql=$akses->ringkasan_peraturan9();
                                             ...
                                             <?php 
                                                ...
                                                if(isset($_POST['simpan1'])){
                                                  ...
                                                  $data123=mysqli_fetch_array($akses->dataringkasan()); 

                                                  $hasil = $data123['angka_kredit']*$angka_kk_saya;
                                                  if ($upload) {
                                                     ...
                                                     $akses->input_pendidikan_1a($riwayat,$angka_kk_saya,$niy,$tanggal,$file1,$Keterangan,$status);
                                                         echo "
                                                            ...
                                                            Swal.fire({
                                                              ...
                                                              if(result.value){
                                                                location.href='data_pengembangan_4c.php'
                                                              }
                                                              })
                                                            </script>
                                                            ";
                               ...
                               if(isset($_POST['pencarian'])){
                                                $cari = $_POST['cari']; 
                                  foreach ($akses->data_pengembangan_4cv3($cari,$username) as $key) {
                                    echo"
                                  <table width='90%'>
                                    <th>
                                    ...
                                    <div class="table-responsive">
                                           <table id="mytable2" class="table table-bordered table-striped" >
                                            ...
                                            <?php
                                                ...
                                                foreach ($akses->data_pengembangan_4cv2($cari,$username) as $lihat) {
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form action="" method="POST" enctype="multipart/form-data">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="from-group">
                                                        <label class="control-label" for="tanggal">Tanggal Kegiatan</label>
                                                        <input type="date" name="tanggal" class="form-control" id="tanggal" required placeholder="Nama">
                                    ...
                                    <div class="table-responsive">
                                          <table id="mytable2" class="table table-bordered table-striped" >
                                            ...
                                            <?php
                                                ...
                                                foreach ($akses->  data_pengembangan_4cv2($cari,$username) as $lihat) {
                                                     $kredit_anda=$lihat['angka_kredit']*$lihat['angka_k1'];
                                                     $tanggal = date("d-m-Y", strtotime($lihat['tanggal']));
                                                    ...
                                                    echo "
                                                        <tr>
                                                            <td>$tanggal</td>
                                                             ...
                                                             <td>$lihat[angka_k1]</td>
                                                             <td>$kredit_anda</td> 
                                                            <td><a href='download.php?file=$lihat[upload_data]' class='btn btn-info btn-sm' onclick='if(!confirm(`apakah anda mau mendownload file?`)){return false}'>Download</td>
                                                              <td><a href='proses_delete_pendidikan_1a.php?id=$lihat[id_riwayat] && upload=$lihat[upload_data]' class='btn btn-danger btn-sm' onclick='if(!confirm(`apakah anda yakin?`)){return false}'>Hapus</a></td> 
