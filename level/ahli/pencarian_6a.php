...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- search form -->
      <form action="pencarian_6a.php" method="POST" class="sidebar-form">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Penunjang
        <small>6a. Pengajar/pelatih Diklat</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Penunjang</a></li>
        <li class="active">6a. Pengajar/pelatih Diklat</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                               ...
                               <h3 align="center">6A. PENGAJAR/PELATIH DIKLAT</h3>      
                               </i> <br><br>
                                                       ...
                                                       <label class="control-label" for="riwayat">Rincian kegiatan</label>
                                                        ...
                                                        <option>Pilih</option>
                                                           <?php
                                                             ...
                                                             $sql=$akses->ringkasan_peraturan13();
                                                     ...
                                                     $akses->input_pendidikan_1a($riwayat,$angka_kk_saya,$niy,$tanggal,$file1,$Keterangan,$status);
                                                         echo "
                                                            ...
                                                            Swal.fire({
                                                              ...
                                                              if(result.value){
                                                                location.href='pelatih_diklat_6a.php'
                                                              }
                                                              })
                                                            </script>
                                                            ";
                               ...
                               if(isset($_POST['pencarian'])){
                                                $cari = $_POST['cari']; 
                                  foreach ($akses->data_pelatihan_6av3($cari,$username) as $key) {
                                    echo"
                                  <table width='90%'>
                                    <th>
                                  ...
                                  <div class="table-responsive">
                                          <table id="mytable2" class="table table-bordered table-striped" >
                                            ...
                                            <?php
                                                ...
                                                foreach ($akses->data_pelatihan_6av2($cari,$username) as $lihat) {
