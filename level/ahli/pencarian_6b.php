...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- search form -->
      <form action="pencarian_6b.php" method="POST" class="sidebar-form">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                               ...
                               if(isset($_POST['pencarian'])){
                                                $cari = $_POST['cari']; 
                                  foreach ($akses-> data_seminar_6bv3($cari,$username) as $key) {
                                    echo"
                                  <table width='90%'>
                                    <th>
                                  ...
                                  <div class="table-responsive">
                                          <table id="mytable2" class="table table-bordered table-striped" >
                                            ...
                                            <?php
                                                ...
                                                foreach ($akses->data_seminar_6bv2($cari,$username) as $lihat) {
