...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- search form -->
      <form action="pencarian_4b.php" method="POST" class="sidebar-form">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Pelayanan perpus
        <small>4b. Menganalisa karya pustakawan</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Menganalisa karya pustaka</a></li>
        <li class="active">4b. Menganalisa karya pustakawan</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                               ...
                               <h3 align="center">4B. MENGANALISA/MENGKRITISI KARYA KEPUSTAKAWANAN</h3>      
                               </i> <br><br>
                                                       ...
                                                       <select id="riwayat" name="riwayat" class="datepicker form-control" required>
                                                        <option>Pilih</option>
                                                           <?php
                                                             ...
                                                             $sql=$akses->ringkasan_peraturan8();
                                                     ...
                                                     $akses->input_pendidikan_1a($riwayat,$angka_kk_saya,$niy,$tanggal,$file1,$Keterangan,$status);
                                                         echo "
                                                            ...
                                                            Swal.fire({
                                                              ...
                                                              if(result.value){
                                                                location.href='data_pengembangan_4b.php'
                                                              }
                                                              })
                                                            </script>
                                                            ";
                               ...
                               if(isset($_POST['pencarian'])){
                                                $cari = $_POST['cari']; 
                                  foreach ($akses->data_pengembangan_4bv3($cari,$username) as $key) {
                                    echo"
                                  <table width='90%'>
                                    <th>
                                    ...
                                    <div class="table-responsive">
                                         <table id="mytable2" class="table table-bordered table-striped" >
                                            ...
                                            <?php
                                                ...
                                                foreach ($akses->data_pengembangan_4bv2($cari,$username) as $lihat) {
