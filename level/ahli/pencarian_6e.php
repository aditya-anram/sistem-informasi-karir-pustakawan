...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- search form -->
      <form action="pencarian_6e.php" method="POST" class="sidebar-form">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                               ...
                               <h3 align="center">6E. GELAR KESARJANAAN</h3>      
                               </i> <br><br>
                                             ...
                                             <?php 
                                                ...
                                                if(isset($_POST['simpan1'])){
                                                  ...
                                                  if ($upload) {
                                                     ...
                                                     $akses->input_pendidikan_1a($riwayat,$angka_kk_saya,$niy,$tanggal,$file1,$Keterangan,$status,$penilai);
                                                         echo "
                                                              <script type='text/javascript'>
                                                            Swal.fire({
                                                              position: 'middle',
                               ...
                               if(isset($_POST['pencarian'])){
                                                $cari = $_POST['cari']; 
                                  foreach ($akses-> data_gelar_6ev3($cari,$username) as $key) {
                                    echo"
                                  <table width='90%'>
                                    <th>
                                  ...
                                  <div class="table-responsive">
                                          <table id="mytable2" class="table table-bordered table-striped" >
                                            ...
                                            <?php
                                                ...
                                                foreach ($akses->data_gelar_6ev2($cari,$username) as $lihat) {
