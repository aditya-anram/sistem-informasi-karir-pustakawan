  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>5c. Penyusun buku pedoman</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Pengembangan Profesi</a></li>
        <li class="active">5c. Penysun buku pedoman</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                               ...
                               <h3 align="center">5C. PENYUSUN BUKU PEDOMAN</h3>      
                               </i> <br><br>
                                                       ...
                                                       <select id="riwayat" name="riwayat" class="datepicker form-control" required>
                                                        <option>Pilih</option>
                                                           <?php
                                                             ...
                                                             $sql=$akses->ringkasan_peraturan12();
                                                     ...
                                                     $akses->input_pendidikan_1a($riwayat,$hasil,$niy,$tanggal,$file1,$Keterangan,$status);
                                                         ...
                                                         echo "
                                                            ...
                                                            Swal.fire({
                                                              ...
                                                              if(result.value){
                                                                location.href='data_penyusun_5c.php'
                                                              }
                                                              })
                                                            </script>
                                                            ";
                               ...
                               <?php
                                  foreach ($akses->data_penyusun_5cv1($username) as $key) {
                                    echo"
                                  <table width='90%'>
                                    <th>
                                    ...
                                    <div class="table-responsive">
                                          <table id="mytable2" class="table table-bordered table-striped" >
                                            ...
                                            <?php
                                                ...
                                                foreach ($akses->data_penyusun_5c($username) as $lihat) {
