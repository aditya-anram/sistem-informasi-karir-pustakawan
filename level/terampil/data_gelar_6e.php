...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Penunjang
        <small>6e. Gelar kesarjanaan lain</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Penunjang</a></li>
        <li class="active">6e. Gelar kesarjanaan lain</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                               ...
                               <h3 align="center">6E. GELAR KESARJANAAN LAIN</h3>      
                               </i> <br><br>

                               

                                <div><button type="button"  class="btn btn-primary" data-toggle="modal" data-target="#tambah">Tambah isian</button></div>
                                                   ...
                                                   <div class="from-group">
                                                    ...
                                                    <div class="from-group">
                                                       <label class="control-label" for="riwayat">Rincian kegiatan</label>
                                                        <select id="provinsi" name="riwayat" class="form-control" class="chosen" required>
                                                        <option>Pilih</option>
                                                           <?php

                                                             $sql=$akses->ringkasan_peraturan17();
                                                    ...
                                                    <div class="from-group">
                                                        ...
                                                        <textarea name="keterangan" class="form-control" rows="3" required placeholder="Silahkan isi komentar anda"></textarea>
                                                  ...
                                                  if ($upload) {
                                                     ...
                                                     $akses->input_pendidikan_1a($riwayat,$angka_kk_saya,$niy,$tanggal,$file1,$Keterangan,$status);
                                                         echo "
                                                            ...
                                                            Swal.fire({
                                                              ...
                                                              if(result.value){
                                                                location.href='data_gelar_6e.php'
                                                              }
                                                              })
                                                            </script>
                                                            ";
                                                   ...
                                                   echo "
                                                            ...
                                                            Swal.fire({
                                                              position: 'middle',
                                                              type: 'error',
                                                              title: 'File yang anda masukan tidak sesuai !!',
                                                              showConfirmButton: true,
                                                              confirmButtonColor: '#3085d6',
                                                              confirmButtonText: 'Kembali'
                               ...
                               <?php
                                  foreach ($akses-> data_gelar_6ev1($username) as $key) {
                                    echo"
                                  <table width='90%'>
                                    <th>
                                  ...
                                  <div class="table-responsive">
                                          <table id="mytable2" class="table table-bordered table-striped" >
                                            ...
                                            <?php
                                                ...
                                                foreach ($akses->data_gelar_6e($username) as $lihat) {
                                                    ...
                                                    echo "
                                                         <tr>
                                                            <td>$tanggal</td>
                                                             ...
                                                             // if($lihat['status_penilai']=="belum diperiksa"){
                                                             //  echo "<td>Belum diperiksa</td>";
                                                             // }else if($lihat['status_penilai']=="perbaikan"){
                                                             //  echo "<td><font color='red'>Perbaikan</font></td>";
                                                             // }else if($lihat['status_penilai']=="sudah diperbaiki"){
                                                             //  echo "<td><font color='blue'>Sudah diperbaiki</font></td>";
                                                             // }else{
                                                             //  echo "<td><font color='green'>Diterima</font></td>";
                                                             // }
