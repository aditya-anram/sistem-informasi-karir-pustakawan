                        ...
                        <li class="treeview">
                         ...
                         <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="ubah_data.php"><i class="fa fa-angle-double-right"></i> Lihat Ringkasan Peeraturan</a></li>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                               ...
                               <?php
                                  foreach ($akses-> data_diklat_1bv1($username) as $key) {
                                    echo"
                                  <table width='90%'>
                                    <th>
                                  ...
                                  <div class="table-responsive">
                                          <table id="mytable2" class="table table-bordered table-striped" >
                                            ...
                                            <?php
                                                ...
                                                foreach ($akses->data_diklat_1b($username) as $lihat) {
