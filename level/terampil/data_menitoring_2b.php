...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
       ...
       <!-- search form -->
      <form action="pencarian_2b.php" method="POST" class="sidebar-form">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Pengelolaan perpus
        <small>2b. Monitoring dan evaluasi</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Pengelolaan perpus</a></li>
        <li class="active">2b. Monitoring dan evaluasi</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                               ...
                               <h3 align="center">2B. MONITORING DAN EVALUASI PENYELENGGARAAN KEGIATAN PERPUSTAKAAN</h3>      
                               </i> <br><br>
                               ...
                               <?php
                                  foreach ($akses->data_monitoring_2bv1($username) as $key) {
                                    echo"
                                  <table width='90%'>
                                    <th>
                                    ...
                                    <div class="table-responsive">
                                            ...
                                            <?php
                                                ...
                                                foreach ($akses->data_monitoring_2b($username) as $lihat) {
