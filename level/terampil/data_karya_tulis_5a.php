  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>5a. membuat karya tulis</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Pengembangan Profesi</a></li>
        <li class="active">5a. membuat karya tulis</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                               ...
                               <h3 align="center">5A. Membuat Karya Tulis</h3>      
                               </i> <br><br>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="from-group">
                                                       ...
                                                       <select id="riwayat" name="riwayat" class="datepicker form-control" required>
                                                        <option>Pilih</option>
                                                           <?php
                                                             ...
                                                             $sql=$akses->ringkasan_peraturan10();
                                                     ...
                                                     <div class="from-group">
                                                        ...
                                                        <input type="number" name="penulis" class="form-control" required placeholder="Silahkan isi komentar anda">
                                                        
                                                   </div>

                                                    <div class="from-group">
                                                        <label class="control-label">Penulis</label>
                                                        <select id="status" name="status_penulis" class="datepicker form-control" required>
                                                          <option>Pilih</option>
                                                          <option value="utama">Penulis Utama</option>
                                                          <option value="pembantu">Penulis Pembantu</option>
                                                        </select>
                                                ...
                                                if(isset($_POST['simpan1'])){
                                                  ...
                                                  if($jumlah=='2' && $status_penulis=='utama'){
                                                    $hasil = $angka_kk_saya*60/100;
                                                     ...
                                                     $akses->input_pendidikan_1a($riwayat,$hasil,$niy,$tanggal,$file1,$Keterangan,$status);
                                                         ...
                                                         echo "
                                                            ...
                                                            Swal.fire({
                                                              ...
                                                              if(result.value){
                                                                location.href='data_karya_tulis_5a.php'
                                                              }
                                                              })
                                                            </script>
                                                            ";
                               ...
                               <?php
                                  foreach ($akses->data_karya_tulis_5av1($username) as $key) {
                                    echo"
                                  <table width='90%'>
                                    <th>
                                    ...
                                    <div class="table-responsive">
                                          <table id="mytable2" class="table table-bordered table-striped" >
                                            ...
                                            <?php
                                                ...
                                                foreach ($akses->data_karya_tulis_5a($username) as $lihat) {
                                    ...
                                    <div class="modal-dialog">
                                            ...
                                            <form id="form" enctype="multipart/form-data">
                                                <div class="modal-body" id="modaledit">
                                                    ...
                                                    <div class="from-group">
                                                     ...
                                                     <div class="from-group">
                                                        <label class="control-label" >Jumlah Penulis</label>
                                                        <input type="number" name="penulis" class="form-control" id="penulis" required placeholder="jumlah penulis">
                                                        
                                                   </div>

                                                    <div class="from-group">
                                                        <label class="control-label">Penulis</label>
                                                        <select id="status_penulis" name="status_penulis" class="datepicker form-control" required>
                                                          <option>Pilih</option>
                                                          <option value="utama">Penulis Utama</option>
                                                          <option value="pembantu">Penulis Pembantu</option>
                                                        </select>
                                     ...
                                     <script type="text/javascript">
                                       $(document).on("click", "#edit1", function(){
                                        ...
                                        var status_penulis = $(this).data('status_penulis');
                                            ...
                                            $("#modaledit #riwayat").val(riwayat);
                                             $("#modaledit #tanggal").val(tanggal);
                                              $("#modaledit #status").val(status);
                                               $("#modaledit #status_penulis").val(status_penulis);
                                                $("#modaledit #penulis").val(penulis);
