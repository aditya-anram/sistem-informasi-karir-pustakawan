        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">Terampil</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
              ...
              <span class="info-box-text">Jabatan</span>
               ...
               $data=mysqli_fetch_array($akses->data($username)); 
                    ...
                    $data12=mysqli_fetch_array($akses->total_keseluruhan($username));  
                                        ...
                                        else if($data12['total']<"40" && $data12['status']=="terampil"){                                     
                                           $Jabatan = "xx-0000";
                                          $akses->ubahprofil1($Jabatan,$username);
                                         
                                        }
                                         else if($data12['total']<"60" && $data12['status']=="terampil"){                                     
                                           $Jabatan = "t1-001";
                                          $akses->ubahprofil1($Jabatan,$username);
                                         
                                        } else if($data12['total']<"80" && $data12['status']=="terampil"){                                     
                                           $Jabatan = "t1-002";
                                          $akses->ubahprofil1($Jabatan,$username);
                                        }
                                          else if($data12['total']<"100" && $data12['status']=="terampil" ){                                     
                                           $Jabatan = "t1-003";
                                          $akses->ubahprofil1($Jabatan,$username);
                                        }
                                          else if($data12['total']<"150" && $data12['status']=="terampil"){                                     
                                           $Jabatan = "t2-001";
                                          $akses->ubahprofil1($Jabatan,$username);
                                        }
                                          else if($data12['total']<"200" && $data12['status']=="terampil"){                                     
                                           $Jabatan = "t2-002";
                                          $akses->ubahprofil1($Jabatan,$username);
                                        }
                                          else if($data12['total']<"300" && $data12['status']=="terampil"){                                     
                                           $Jabatan = "t3-001";
                                          $akses->ubahprofil1($Jabatan,$username);
                                        }
                                           else if($data12['total']<"300" && $data12['status']=="terampil"){                                     
              ...
              <table id="example2" class="table table-bordered table-hover">
                                            ...
                                            <table>
                                                ...
                                                $total2 = "belum ada";
                                                 ...
                                                 else if ($data['jebatan']=="Pustakawan Pelaksana"){
                                                  $total2 = "Pustakawan Pelaksana Lanjutan";
                                                 }
                                                 else if ($data['jebatan']=="Pustakawan Pelaksana Lanjutan"){
                                                  $total2 = "Pustakawan Penyelia";
                                                 }
                                                 else if ($data['jebatan']=="Pustakawan Penyelia"){
                                                  $total2 = "Pustakawan Penyelia";
                                                 }
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr >
                  <td colspan="5"  bgcolor='#D3D3D3' align="center">Total Keseluruhan</td>
                  <?php
                  ...
                  foreach ($akses->total_keseluruhan($username) as $key) {
                                                    ...
                                                    <td bgcolor='#ADD8E6'><b>$a[total]<b></td>
                                                     ";?><?php 
                                                      if($key['total']=="")
