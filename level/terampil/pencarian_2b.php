              ...
              <table id="example2" class="table table-bordered table-hover">
                                                       ...
                                                       <select id="riwayat" name="riwayat" class="datepicker form-control" required>
                                                        <option>Pilih</option>
                                                           <?php
                                                             ...
                                                             $sql=$akses->ringkasan_peraturan4();
                                                     ...
                                                     $akses->input_pendidikan_1a($riwayat,$angka_kk_saya,$niy,$tanggal,$file1,$Keterangan,$status);
                                                         ...
                                                         echo "
                                                            ...
                                                            Swal.fire({
                                                              ...
                                                              if(result.value){
                                                                location.href='data_menitoring_2b.php'
                                                              }
                                                              })
                                                            </script>
                                                            ";
                               ...
                               <?php
                                if(isset($_POST['pencarian'])){
                                  ...
                                  foreach ($akses->  data_monitoring_2bv3($cari,$username) as $key) {
                                    echo"
                                  <table width='90%'>
                                    <th>
                                    ...
                                    <div class="table-responsive">
                                          <table id="mytable2" class="table table-bordered table-striped" >
                                            ...
                                            <?php
                                                ...
                                                foreach ($akses-> data_monitoring_2bv2($cari,$username) as $lihat) {
