...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- search form -->
      <form action="pencarian_3b.php" method="POST" class="sidebar-form">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Pelayanan perpus
        <small>3a. Pelayanan pemustaka</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Pelayanan perpus</a></li>
        <li class="active">3a. Pelayanan pemustaka</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                               ...
                               <h3 align="center">3B. PELAYANAN PEMUSTAKA</h3>      
                               </i> <br><br>
                                                       ...
                                                       <select id="riwayat" name="riwayat" class="datepicker form-control" required>
                                                        <option>Pilih</option>
                                                           <?php
                                                             ...
                                                             $sql=$akses->ringkasan_peraturan6();
                                                     ...
                                                     $akses->input_pendidikan_1a($riwayat,$angka_kk_saya,$niy,$tanggal,$file1,$Keterangan,$status);
                                                         ...
                                                         echo "
                                                            ...
                                                            Swal.fire({
                                                              ...
                                                              if(result.value){
                                                                location.href='data_pelayanan_3b.php'
                                                              }
                                                              })
                                                            </script>
                                                            ";
                               ...
                               <?php
                                if(isset($_POST['pencarian'])){
                                  ...
                                  foreach ($akses->  data_pelayanan_3bv3($cari,$username) as $key) {
                                    echo"
                                  <table width='90%'>
                                    <th>
                                    ...
                                    <div class="table-responsive">
                                          <table id="mytable2" class="table table-bordered table-striped" >
                                            ...
                                            <?php
                                                ...
                                                foreach ($akses->  data_pelayanan_3bv2($cari,$username) as $lihat) {
