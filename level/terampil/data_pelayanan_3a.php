          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                               ...
                               <?php
                                  foreach ($akses->data_pelayanan_3av1($username) as $key) {
                                    echo"
                                  <table width='90%'>
                                    <th>
                                    ...
                                    <div class="table-responsive">
                                         <table id="mytable2" class="table table-bordered table-striped" >
                                            ...
                                            <?php
                                                ...
                                                foreach ($akses->data_pelayanan_3a($username) as $lihat) {
                                            ...
                                            <form id="form" enctype="multipart/form-data">
                                                <div class="modal-body" id="modaledit">
                                                   ...
                                                   <div class="from-group">
                                                        ...
                                                        <select id="status" name="status_penilai" class="datepicker form-control" required>
                                                          <option value="tidakjadi">Bukan perbaikan</option>
                                                          <option value="jadi">Perbaikan</option>
                                                        </select>
