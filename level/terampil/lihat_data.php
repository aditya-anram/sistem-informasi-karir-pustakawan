                                                ...
                                                <div class='modal-body'>
                                                    ...
                                                    <div class='from-group'>
                                                        ...
                                                        <select name='pendidikan' class='datepicker form-control' required>
                                                            ...
                                                            <option value='sma' ";?><?php if($lihat['pendidikan']=="sma"){echo "selected=\"selected\"";}?><?php echo ">SMA</option>
                                                            <option value='d2' ";?><?php if($lihat['pendidikan']=="d2"){echo "selected=\"selected\"";}?><?php echo ">Diploma 2</option>
                                                            <option value='d3' ";?><?php if($lihat['pendidikan']=="d3"){echo "selected=\"selected\"";}?><?php echo ">Diploma 3</option>
                                                          </select>
