...
class Sikap{
		...
		public function data_diklat_1bv2($cari,$niy){
			...
			$query = "SELECT riwayat_kerja.tanggal, riwayat_kerja.id_riwayat, riwayat_kerja.niy,  ringkasan_peraturan.rincian, ringkasan_peraturan.angka_kredit, riwayat_kerja.angka_kredit_saya as angka_k1, riwayat_kerja.upload_data  from ringkasan_peraturan join riwayat_kerja on ringkasan_peraturan.id_rp=riwayat_kerja.riwayat and ringkasan_peraturan.butir = 'DIKLAT FUNGSIONAL/TEKNIS KEPUSTAKAWANAN serta memperoleh surat tanda tamat pendidikan dan pelatihan atau setifikat' where riwayat_kerja.tanggal like '%$cari%' or ringkasan_peraturan.rincian like '%$cari%' or riwayat_kerja.angka_kredit_saya like '%cari%' and riwayat_kerja.niy='$niy'";
		...
		public function data_pelatihan_6a($niy){
			...
			$query = "SELECT riwayat_kerja.tanggal, riwayat_kerja.id_riwayat, riwayat_kerja.niy,  ringkasan_peraturan.rincian, ringkasan_peraturan.angka_kredit, riwayat_kerja.angka_kredit_saya as angka_k1, ringkasan_peraturan.status, riwayat_kerja.upload_data, riwayat_kerja.keterangan, riwayat_kerja.riwayat from ringkasan_peraturan join riwayat_kerja on ringkasan_peraturan.id_rp=riwayat_kerja.riwayat where ringkasan_peraturan.butir = 'Pengajar/Pelatih Pada Diklat Fungsional/Teknis Bidang Kepustakawanan' and riwayat_kerja.niy='$niy'";
		...
		public function data_seminar_6b($niy){
			...
			$query = "SELECT riwayat_kerja.tanggal, riwayat_kerja.id_riwayat, riwayat_kerja.niy,  ringkasan_peraturan.rincian, ringkasan_peraturan.angka_kredit, riwayat_kerja.angka_kredit_saya as angka_k1, ringkasan_peraturan.status, riwayat_kerja.upload_data, riwayat_kerja.keterangan, riwayat_kerja.riwayat from ringkasan_peraturan join riwayat_kerja on ringkasan_peraturan.id_rp=riwayat_kerja.riwayat where ringkasan_peraturan.butir = 'Peran Serta Dalam Seminar/Lokakarya/Konferensi Di Bidang Kepustakawanan' and riwayat_kerja.niy='$niy'";
		...
		public function data_gelar_6e($niy){
			...
			$query = "SELECT riwayat_kerja.tanggal, riwayat_kerja.id_riwayat, riwayat_kerja.niy,  ringkasan_peraturan.rincian, ringkasan_peraturan.angka_kredit, riwayat_kerja.angka_kredit_saya as angka_k1, ringkasan_peraturan.status, riwayat_kerja.upload_data, riwayat_kerja.keterangan, riwayat_kerja.riwayat from ringkasan_peraturan join riwayat_kerja on ringkasan_peraturan.id_rp=riwayat_kerja.riwayat where ringkasan_peraturan.butir = 'Memperoleh Gelar/Ijazah Keserjanaan Lainnya' and riwayat_kerja.niy='$niy'";
		...
		public function ubahriwayat2($riwayat, $tanggal, $keterangan, $niy, $id_riwayat){
			...
			public function ubahriwayat3($riwayat, $tanggal, $keterangan, $niy, $id_riwayat, $upload_data){
		...
		public function ubahriwayat2a($riwayat, $tanggal, $keterangan, $angka_k1, $niy, $id_riwayat){
		...
		public function ubahriwayat3a($riwayat, $tanggal, $keterangan, $angka_k1, $niy, $id_riwayat, $upload_data){
		...
		public function dataringkasan(){
			...
			$query = "SELECT * from ringkasan_peraturan where status='terampil'";
		...
		public function ringkasan_peraturan1(){ 
			...
			$query="SELECT * from ringkasan_peraturan where butir = 'Pendidikan Sekolah Dan Memperoleh Gelar/Ijazah' and status='terampil' ";
		...
		public function ringkasan_peraturan2(){ 
			...
			$query="SELECT * from ringkasan_peraturan where butir = 'DIKLAT FUNGSIONAL/TEKNIS KEPUSTAKAWANAN serta memperoleh surat tanda tamat pendidikan dan pelatihan atau setifikat'";
		...
		public function ringkasan_peraturan3(){ 
			...
			$query="SELECT * from ringkasan_peraturan where butir = 'Perencanaan Penyelenggaraan Kegiatan Perpustakaan' and status='terampil' ";
		...
		public function ringkasan_peraturan4(){ 
			...
			$query="SELECT * from ringkasan_peraturan where butir = 'Monitoring Dan Evaluasi Penyelenggaraan Kegiatan Perpustakaan' and status='terampil' ";
		...
		public function ringkasan_peraturan5(){ 
			...
			$query="SELECT * from ringkasan_peraturan where butir = 'Pelayanan Teknis' and status='terampil' ";
		...
		public function ringkasan_peraturan6(){ 
			...
			$query="SELECT * from ringkasan_peraturan where butir = 'Pelayanan Pemustaka' and status='terampil' ";
		...
		public function ringkasan_peraturan7(){ 
			...
			$query="SELECT * from ringkasan_peraturan where butir = 'Pengembangan Kepustakawanan' and status='terampil' ";
		...
		public function ringkasan_peraturan10(){ 
			...
			$query="SELECT * from ringkasan_peraturan where butir = 'Membuat Karya Tulis/Karya Ilmiah Di Bidang Kepustakawanan' and status='terampil' ";
		...
		public function ringkasan_peraturan11(){ 
			...
			$query="SELECT * from ringkasan_peraturan where butir = 'Penerjemahan/Penyaduran Buku Dan/Atau Bahan-Bahan Lain Di Bidang Kepustakawanan' and status='terampil' ";
		...
		public function ringkasan_peraturan12(){ 
			...
			$query="SELECT * from ringkasan_peraturan where butir = 'Penyusunan Buku Pedoman/Ketentuan Pelaksanaan/Ketentuan Teknis Di Bidang Kepustakawanan' and status='terampil' ";
		...
		public function ringkasan_peraturan13(){ 
			...
			$query="SELECT * from ringkasan_peraturan where butir = 'Pengajar/Pelatih Pada Diklat Fungsional/Teknis Bidang Kepustakawanan' and status='terampil' ";
		...
		public function ringkasan_peraturan14(){ 
			...
			$query="SELECT * from ringkasan_peraturan where butir = 'Peran Serta Dalam Seminar/Lokakarya/Konferensi Di Bidang Kepustakawanan' and status='terampil' ";
		...
		public function ringkasan_peraturan15(){ 
			...
			$query="SELECT * from ringkasan_peraturan where butir = 'Keanggotaan Dalam Organisasi Profesi' and status='terampil' ";
		...
		public function ringkasan_peraturan16(){ 
			...
			$query="SELECT * from ringkasan_peraturan where butir = 'Perolehan Penghargaan/Tanda Jasa' and status='terampil' ";
		...
		public function ringkasan_peraturan17(){ 
			...
			$query="SELECT * from ringkasan_peraturan where butir = 'Memperoleh Gelar/Ijazah Keserjanaan Lainnya' and status='terampil' ";
