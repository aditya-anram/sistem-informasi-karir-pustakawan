              ...
              <table id="example2" class="table table-bordered table-hover">
                                                  ...
                                                  if ($upload) {
                                                    ...
                                                    echo "
                                                            ...
                                                            Swal.fire({
                                                              ...
                                                              if(result.value){
                                                                location.href='data_pengambangan_4a.php'
                                                              }
                                                              })
                                                            </script>
                                                            ";
                               ...
                               <?php
                                if(isset($_POST['pencarian'])){
                                  ...
                                  foreach ($akses->data_pengembangan_4av3($cari,$username) as $key) {
                                    echo"
                                  <table width='90%'>
                                    <th>
                                    ...
                                    <div class="table-responsive">
                                          <table id="mytable2" class="table table-bordered table-striped" >
                                            ...
                                            <?php
                                                ...
                                                foreach ($akses->  data_pengembangan_4av2($cari,$username) as $lihat) {
