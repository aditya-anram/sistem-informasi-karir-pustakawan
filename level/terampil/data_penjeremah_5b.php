  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>5b. Penerjemahan/Penyaduran</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Pengembangan Profesi</a></li>
        <li class="active">5b. Penerjemahan/Penyaduran</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                               ...
                               <h3 align="center">5B. PENERJEMAHAN/PENYADURAN</h3>      
                               </i> <br><br>
                                                       ...
                                                       <select id="riwayat" name="riwayat" class="datepicker form-control" required>
                                                        <option>Pilih</option>
                                                           <?php
                                                             ...
                                                             $sql=$akses->ringkasan_peraturan11();
                                                     ...
                                                     $akses->input_pendidikan_1a($riwayat,$hasil,$niy,$tanggal,$file1,$Keterangan,$status);
                                                         ...
                                                         echo "
                                                            ...
                                                            Swal.fire({
                                                              ...
                                                              if(result.value){
                                                                location.href='data_penjeremah_5b.php'
                                                              }
                                                              })
                                                            </script>
                                                            ";
                               ...
                               <?php
                                  foreach ($akses->data_penerjemah_5bv1($username) as $key) {
                                    echo"
                                  <table width='90%'>
                                    <th>
                                    ...
                                    <div class="table-responsive">
                                          <table id="mytable2" class="table table-bordered table-striped" >
                                            ...
                                            <?php
                                                ...
                                                foreach ($akses->data_penerjemah_5b($username) as $lihat) {
