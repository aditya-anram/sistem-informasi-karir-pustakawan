...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Penunjang
        <small>6b. Seminar/lokakarya</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Penunjang</a></li>
        <li class="active">6b. Seminar/lokakarya</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                               ...
                               <h3 align="center">6B. SEMINAR/LOKAKARYA</h3>      
                               </i> <br><br>
                                                       ...
                                                       <label class="control-label" for="riwayat">Rincian kegiatan</label>
                                                        ...
                                                        <option>Pilih</option>
                                                           <?php
                                                             ...
                                                             $sql=$akses->ringkasan_peraturan14();
                                                  ...
                                                  if ($upload) {
                                                     ...
                                                     $akses->input_pendidikan_1a($riwayat,$angka_kk_saya,$niy,$tanggal,$file1,$Keterangan,$status);
                                                         echo "
                                                            ...
                                                            Swal.fire({
                                                              ...
                                                              if(result.value){
                                                                location.href='data_seminar_6B.php'
                                                              }
                                                              })
                                                            </script>
                                                            ";
                                                   ...
                                                   echo "
                                                            ...
                                                            Swal.fire({
                                                              ...
                                                              if(result.value){
                                                                location.href='data_seminar_6a.php'
                                                              }
                                                              })
                                                            </script>
                                                            ";
                               ...
                               <?php
                                  foreach ($akses-> data_seminar_6bv1($username) as $key) {
                                    echo"
                                  <table width='90%'>
                                    <th>
                                  ...
                                  <div class="table-responsive">
                                          <table id="mytable2" class="table table-bordered table-striped" >
                                            ...
                                            <?php
                                                ...
                                                foreach ($akses->data_seminar_6b($username) as $lihat) {
